# decentralized_donating-contracts
...
By default the template creates a single `HelloWorld` contract under decentralized_donating folder in the `smart_contracts` directory. To add a new contract:
